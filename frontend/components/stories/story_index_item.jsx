    ...
    return (
      <div className="story-index-item-container">
        ...
        <div className="story-index-item-text">
          ...
          <Link to={`/stories/show/${id}`}><h2 className="story-index-title">{title}</h2></Link>
          <Link to={`/stories/show/${id}`}><p className="story-index-body">{ body.substring(0, 113) }...</p></Link>
        ...
        <Link to={`/stories/show/${id}`}><img className="story-index-item-image" src={window.indexStoryImage} /></Link>
